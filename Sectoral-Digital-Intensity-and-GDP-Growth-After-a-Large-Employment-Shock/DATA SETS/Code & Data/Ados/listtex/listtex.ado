...
mata:listtex_token_count("nhead","headlines");
tokenize `"`headlines'"';
forv i1=1(1)`nhead' {;
  local headline`i1' `"`macval(`i1')'"';
};
mata:listtex_token_count("nfoot","footlines");
tokenize `"`footlines'"';
forv i1=1(1)`nfoot' {;
...
void listtex_token_count(string scalar tokencount,string scalar tokenlist)
{
/*
