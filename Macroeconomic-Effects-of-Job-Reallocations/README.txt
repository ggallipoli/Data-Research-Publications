...
As pointed out by Barnichon (Building a composite Help-Wanted Index, Economics Letters, December 2010) the HWI index does not accurately reflect the amount of open vacancies because it only considers newspaper advertising and excludes online ads. The HWI index was published in print by the Conference Board between  1951m1–2008m5. The Conference
Board online HWI has been available since 2005m5. A different source of information about the number of vacancies is the JOLTS, produced by the BLS. This series starts in December 2000 and is ongoing.

Barchinon's methodology to obtain a long and consistent time series for vacancies is the following:
