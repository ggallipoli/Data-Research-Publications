...
save "K:\Dropouts\Factor Analysis\December 2009\dat\robustness data.dta", replace
...
outsheet using "K:\Dropouts\Factor Analysis\December 2009\dat\DEC1DATB.raw", nonames replace

clear 
insheet using  "K:\Dropouts\Factor Analysis\December 2009\predicted factors.csv" 
...
sort rec 
merge rec using "K:\Dropouts\Factor Analysis\December 2009\dat\robustness data.dta"

drop _merge

save "K:\Dropouts\Factor Analysis\December 2009\dat\analysis robustness data.dta", replace
