...
set more off
capture log close
log using "K:\Dropouts\Factor Analysis\QE Programs\Reduced Form\Table 2 Boys OUT.txt", text replace


#delim  ;
/****************NOT USED********************************/ ;
probit dp  lnfi  pedn2 pedn3 pedn4 pedn5 pedn6 nfld pei ns nb pq sk mb ab bc native rural imm moves otpar lonepar 
parpptx1 parpptx2 parpptx3 parpptx4 parpptx5 parpptx6 parpptx7 tryhard hwkonetime numsib monthb [pw =newpw ], cluster(schoolid) ;
...
mfx,  varlist(tryhard hwkonetime native rural imm moves otpar lonepar numsib monthb ) at(
pedn2 = 0,
pedn3 =  0,
pedn4 =  1,
pedn5 =  0,
...
probit dp  lnfi  pedn2 pedn3 pedn4 pedn5 pedn6 nfld pei ns nb pq sk mb ab bc native rural imm moves otpar lonepar numsib monthb 
parpptx1 parpptx2 parpptx3 parpptx4 parpptx5 parpptx6 parpptx7 tryhard hwkonetime 
frhsimp frskip frdrop frmoreed frtroub frsmoke frswkhrd  depchild y1smokewkl  comprat tearat lowmat  yunemp 
 [pw =newpw ], cluster(schoolid) ;

predictnl bcol3 = normal(_b[lnfi]*10.1266311 + 
_b[pedn4] + 
_b[nfld]* mnfld + 
_b[pei]* mpei + 
_b[ns]* mns + 
...
mfx,  varlist(yunemp tryhard hwkonetime comprat tearat lowmat frhsimp frskip frdrop frmoreed frtroub frsmoke frswkhrd  depchild y1smokewkl native rural imm moves otpar lonepar numsib monthb ) at(
pedn2 = 0,
pedn3 =  0,
pedn4 =  1,
pedn5 =  0,
