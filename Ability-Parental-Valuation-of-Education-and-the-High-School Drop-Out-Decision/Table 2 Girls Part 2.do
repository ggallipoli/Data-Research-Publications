...
gen esteem =  y1sselfest 
gen efficacy = y1sselfeff 
...
set more off
capture log close
log using "K:\Dropouts\Factor Analysis\QE Programs\Reduced Form\Table 2 Extra Columns Girls OUT.txt", text replace
